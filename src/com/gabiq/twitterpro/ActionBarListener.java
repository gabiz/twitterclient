...
public class ActionBarListener<T extends SherlockFragment> implements TabListener {
    ...
    public ActionBarListener(SherlockFragmentActivity activity, String tag, Class<T> clz) {
        mActivity = activity;
        mTag = tag;
        mClass = clz;
    ...
    public ActionBarListener(int fragmentContainerId, SherlockFragmentActivity activity,
